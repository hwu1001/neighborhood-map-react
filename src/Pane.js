// Made changes from the file in neighborhood-map-react/node_modules/react-leaflet/es/Pane.js
// Changes handle updating the className on the component and allowing for more than
// one class to be added/removed a time
    ...
    if (this.props.name !== prevProps.name) {
      ...
      if (prevProps.className && this.props.className !== prevProps.className) {
        ...
        if (pane != null && prevProps.className != null) {
          // NEW
          var arr = prevProps.className.split(' ');
          pane.classList.remove(...arr);
          // END NEW
